...
public class PathSplinePerformance : MonoBehaviour
{
		private void Start()
	{
		...
		{
			float num3 = Mathf.Cos(num * 0.017453292f) * this.circleLength + Random.Range(0f, this.randomRange);
			float num4 = Mathf.Sin(num * 0.017453292f) * this.circleLength + Random.Range(0f, this.randomRange);
